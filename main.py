...
models.LangchainSearch.openai_api_key = os.getenv("OPENAI_API_KEY")
models.LangchainSearch.serpapi_api_key = os.getenv("SERP_API_KEY")
...
def on_message(message_history: List[Message], state: dict = None):
    ...
    bot_response = models.LangchainSearch.generate(message_history) 
